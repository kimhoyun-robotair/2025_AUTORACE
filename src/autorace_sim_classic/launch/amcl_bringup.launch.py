...
def generate_launch_description():
    # pkg path
    pkg_share = launch_ros.substitutions.FindPackageShare(package='autorace_sim_classic').find('autorace_sim_classic')
    # robot model path
    ...
    map_dir = os.path.join(pkg_share, 'demomap')
    map_file = 'autorace.yaml'
